...
/*
 ...
 사람 ---> 통역가 ---> 컴퓨터
         (Compiler)
  -컴퓨터는 프로그래머가 작성한 코드를 이해할 수 없기 문에 기계어로 변환해주어야함.
...
/*
  함수(function)
   ...
   main 함수 : 프로그램의 시작점 
	...
	: main함수를 호출할 때 void(아무것도 받지않음)값을 받으며 함수가 종료될 int(정수형) 값을 반환한다.
*/
...
int main(void)
{
	printf("hello world!!!!\n");
	// 문자열
	// "내용" : " "안에 있는 내용을 문장으로 표현할  사용한다.
	printf("hello world!!\n\n\n\n\n");
	// f : formatted(서식화된) 다양한 서식에 맞춰 출력해준다.
	/*
	Escape Sequence
	: \ 뒤에 한 문자나 숫자 조합으로 줄바꿈, 특정 문자를 표현할 사용 ex) \n, \t, \" ...
	*/
	printf("\thello world\n");
	printf("10\n");
	printf("%d\n", 10);
